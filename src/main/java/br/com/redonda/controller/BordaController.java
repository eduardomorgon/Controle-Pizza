...
import br.com.redonda.service.BordaService;
...
public class BordaController {
    ...
    public void save(@RequestBody Borda borda, HttpServletRequest request, HttpServletResponse response) {
